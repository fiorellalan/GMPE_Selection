...
Provides a Tkinter GUI for browsing, filtering, and selecting GMPEs
from the catalogue CSV, then saving the selection to a JSON file.
...
def _detect_dark_mode():
    """Return True if macOS is in dark‑appearance mode."""
    try:
        import subprocess
